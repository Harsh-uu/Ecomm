...
function App() {
  return (
    <div>
      <div className='sm:grid grid-cols-3 sm:relative lg:h-screen  w-[100%]'>
      ...
      <div className='flex justify-between  mt-6 absolute top-0 w-full left-0 bg-transparent z-40'>
        <nav className='sm:flex lg:gap-6 md:gap-4 sm:gap-3 xl:ml-28 lg:ml-20 md:ml-14 sm:ml-10 sm:text-sm md:text-base lg:text-lg xl:text-lg hidden sm:block'>
          <li className='list-none hover:text-teal-500 hover:scale-110 cursor-pointer'>Shop</li>
          <li className='list-none'>▪️</li>
          <li className='list-none hover:text-teal-500 hover:scale-110 cursor-pointer'>Category</li>
          <li className='list-none'>▪️</li>
          <li className='hover:text-teal-500 list-none hover:scale-110 cursor-pointer'>Contact</li>
        </nav>
        <div className='sm:hidden ml-5 text-lg'>
          <button><LiaGripLinesSolid className='hover:text-teal-500 hover:scale-110'/></button>
        </div>
        <h1 className='font-medium sm:text-sm md:text-base lg:text-lg xl:text-lg'>🖤ERIKO</h1>
        <nav className='flex list-none xl:mr-28 lg:mr-20 md:mr-14 sm:mr-10 mr-5 text-lg sm:text-lg md:text-xl lg:text-2xl xl:text-2xl'>
          <li><IoSearchOutline className='hover:text-teal-500 hover:scale-110 cursor-pointer'/></li>
          <li><IoCartOutline className='xl:ml-10 lg:ml-9 md:ml-8 sm:ml-6 ml-0 hover:text-teal-500 hover:scale-110 cursor-pointer'/></li>
          <li><IoPersonAddOutline className='xl:ml-10 lg:ml-9 md:ml-8 sm:ml-6 ml-0 hover:text-teal-500 hover:scale-110 cursor-pointer'/></li>
        </nav>
        </div>
        ...
        <div className='bg-gradient-to-t from-[#e0e0e4] to-[#f6f6fa]  -skew-x-6 relative hidden sm:block h-screen' >
        </div>
